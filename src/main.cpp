...
#define  APP_TASK_TOUCH_STK_SIZE             256
...
static OS_STK appTaskTouchStk[APP_TASK_TOUCH_STK_SIZE];
...
static void appTaskTouch(void *pdata);
...
static AR1021I2C touch(P0_27, P0_28, P2_25);
...
int main() {
  ...
  /* Create the tasks */
  OSTaskCreate(appTaskTouch,                               
               (void *)0,
               (OS_STK *)&appTaskTouchStk[APP_TASK_TOUCH_STK_SIZE - 1],
               APP_TASK_TOUCH_PRIO);
...
static void appTaskLCD(void *pdata) {
  ...
  d->setCursor(2, 2);
	d->printf("EN0572 Touchscreen Demo");
